...
export const UPDATE_SEND_NFT = 'UPDATE_SEND_NFT';
...
export const SET_PENDING_NFTS = 'SET_PENDING_NFTS';
export const CLEAR_PENDING_NFTS = 'CLEAR_PENDING_NFTS';
export const UPDATE_NFT_METAS = 'UPDATE_NFT_METAS';
