 ...
 * @property {'multiSignCreate'} MULTI_SIGN_CREATE - When a transaction is created by a multiSig account.
 ...
 * nonce being accepted
 * @property {'multiSign'} MULTISIGN - the multiSig transaction need more sinatures for publishing
 */
